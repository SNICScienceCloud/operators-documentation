...
Created with:
    ...
    neutron subnet-create  --allocation-pool start=130.239.81.1,end=130.239.81.253 --gateway 130.239.81.254 --disable-dhcp --name public-81 --ip-version 4 --dns-nameserver 130.239.1.90 *EXTERNAL_NETWORK_CIDR* 130.239.81.0/24
